...
## Работу с API не вижу смысла показывать, там ничего интересного, просто подключение по апи и отображение всей информации по широте и долготе, в файле ApiWorker. 
